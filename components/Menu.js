...
function Menu() {
  ...
  if (user.manager === true) {
    managerSection = (
      <Button href="/dashboardManager" className={styles.liens}>
        {" "}
        Dashboard manager
      </Button>
    );
  ...
  if (user.manager === false) {
    userSection = (
      <div className={styles.titre}>
        MESSAGES
        <div>
          <Button href="/messages" className={styles.liens}>
            {" "}
            Mes messages
          </Button>
        </div>
  ...
  if (derniereSemaine === semaine) {
    qhebdoSection = (
      <Button href="/qhebdosaisi" className={styles.liens}>
        {" "}
        Quiz de la semaine
      </Button>
    );
    ...
    qhebdoSection = (
      <Button href="/qhebdo" className={styles.liens}>
        {" "}
        Quiz de la semaine
      </Button>
    );
      ...
      <div className={styles.menusection}>
        <div className={styles.menuSousSection}>
          <div className={styles.titre}>
            ...
            <div>
              <div>
                <Button href="/dashboard" className={styles.liens}>
                  {" "}
                  Mon dashboard{" "}
                </Button>
              </div>
        ...
        <div className={styles.menuSousSection}>
          <div className={styles.titre}>
            REPORTINGS
            <div>
              <Button href="/reportings" className={styles.liens}>
                {" "}
                Mes reportings
              </Button>
            </div>
